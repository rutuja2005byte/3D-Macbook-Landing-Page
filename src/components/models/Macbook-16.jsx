  ...
  React.useEffect(() => {
    if (props.caseColor) {
      if (materials.PaletteMaterial001) {
        materials.PaletteMaterial001.color.set(props.caseColor);
      }
      if (materials.PaletteMaterial002) {
        materials.PaletteMaterial002.color.set(props.caseColor);
      }
      if (materials.PaletteMaterial003) {
        materials.PaletteMaterial003.color.set(props.caseColor);
      }
    }
  }, [props.caseColor, materials]);
